...
Fisher’s exact test and 2-tailed Student’s t test were used for comparison of categorical and continuous variables, as appropriate, with significance set at P < .05. Exploratory.io version 6.1.1.4 was used for statistical calculations.
...
![Patient Flow for Poisoning of Birth Control Tablets](https://github.com/mufflyt/birth_control/blob/master/data_flow_birth_control.jpeg)

# Results
Over the 10-year period from 2010 to 2019, there were an estimated 323,597 poisonings described from tablet medications.  Of those 3,236 ED visits for birth control poisoning was estimated using our sample size of 74 patients. Assessing the entire 10-year period (2010−2019), we found a statistically significant, overall decreasing linear trend (p<0.05, Figure 1).  The majority of patients poisoned by birth control were children with a majority being male between the ages of 1 and 4 years old (74.4%) with the route of exposure always being ingestion.  A total of 404 (65.8%) patients in the sample studied were male, and the remainder (34.2%) of 210 patients were female.  While the majority of poisoning cases were treated and released from the hospital, 4.1% were admitted (Figure 4). Upon organizing the data we noted that patients ingested between one and and eighteen birth control pills prior to visiting the emergency department.  Dosage of the tablets ingested was not available for any of the cases.  Children acquired the tablets by picking them up when the tablets were spilled or chewing through the packaging the majoirty of the time.  In less than four percent of cases was it determined if the pills were placebo or active medication tablets.  A plurailty of the poisoning occured from the patient's mother's birth control prescription.  In three percent of cases a twin or a sibling was present who had also eaten the birth control tablets.  There were no stastical differences in age, race, or sex regarding those who ingested birth control tablets (p>0.05 for all, figure 2, figure 3).  Visits to the ED for this issue occurred most often on a weekend during the summer months.  No deaths were reported in this cohort.  
